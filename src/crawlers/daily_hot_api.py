...
# 21个标准赛道及其细分赛道映射
CHANNEL_MAPPING = {
    '动画': ['MAD·AMV', 'MMD·3D', '短片手书配音', '模玩周边', '特摄', '动漫杂谈', '动漫', '动画', '同人·手书'],
    ...
    '影视': ['影视解说', '影视剪辑', '影评', '小剧场', '短片', '影视杂谈', '影视', '海外剧', '国产剧'],
    '番剧': ['连载动画', '完结动画', '番剧资讯', '官方延伸', '新番速览', '番剧'],
    '电影': ['院线电影解说', '经典影片剪辑', '短片电影', '电影杂谈', '海外影片', '电影'],
    '鬼畜': ['鬼畜调教', '音 MAD', '人力 VOCALOID', '鬼畜剧场', '教程演示', '鬼畜'],
    '舞蹈': ['宅舞', '街舞', '中国舞', '明星舞蹈', '手势舞', '舞蹈教程', '舞蹈综合', '舞蹈', '颜值·网红舞'],
    '生活': ['日常 Vlog', '搞笑', '手工', '家装', '户外', '探店', '生活技巧', '综合', '生活', '家居房产', '三农', '亲子'],
    '国创': ['国产动画', '国产原创二创', '布袋戏', '动态漫·广播剧', '国创资讯', '国创', '国产原创相关'],
    '纪录片': ['人文纪实', '自然地理', '历史档案', '社会观察', '行业纪实', '纪录片'],
    '科技': ['数码测评', '机械 DIY', '极客硬件', '天文星海', '数码教程', '黑科技', '科技', '科学科普', '科工机械', 'AI影像', '计算机技术'],
    '资讯': ['社会热点', '财经产业', '行业快讯', '民生观察', '国际资讯', '资讯', '财经商业'],
    '知识': ['校园学习', '历史人文', '法律科普', '心理', '公考', '财经科普', '野生技术协会', '知识', '人文历史', '野生技能协会'],
    '美食': ['家常菜', '烘焙', '探店', '食材测评', '野外美食', '美食教程', '甜品', '美食'],
    '动物圈': ['喵星人', '汪星人', '小宠异宠', '野生动物', '饲养科普', '动物日常', '动物圈'],
    '汽车': ['新车测评', '改装', '自驾', '用车知识', '二手车', '摩托', '车展', '汽车', '出行', '新能源车', '赛车'],
    '运动': ['健身', '篮球', '足球', '户外徒步', '球类', '格斗', '跑步', '赛事解说', '运动'],
    '时尚': ['美妆', '穿搭', '护肤', '彩妆测评', '发型', '时尚穿搭', '医美科普', '时尚', '仿妆cos'],
